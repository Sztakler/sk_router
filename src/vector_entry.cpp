...
struct in_addr VectorEntry::getBroadcastAdress() {
  ...
  return getBroadcastAdress(this->target_network, this->subnet_mask);
}
...
struct in_addr VectorEntry::getNetworkAdress() {
  ...
  return getNetworkAdress(this->target_network, this->subnet_mask);
}
...
struct in_addr VectorEntry::getHostAdress() {
  ...
  // return host_address;
  return getHostAdress(this->target_network, this->subnet_mask);
}

struct in_addr VectorEntry::getBroadcastAdress(struct in_addr address,
                                               uint8_t subnet_mask) {
...
struct in_addr VectorEntry::getNetworkAdress(struct in_addr address,
                                             uint8_t subnet_mask) {
...
struct in_addr VectorEntry::getHostAdress(struct in_addr address,
                                          uint8_t subnet_mask) {
...
VectorEntry::VectorEntry(const char *ip_address_string,
  ...
  this->target_network =
      this->getNetworkAdress(this->target_network, target_network_mask);
